...
class block_idflashcards extends block_list {
    function init() {
        $this->title = get_string('pluginname', 'block_idflashcards');
    }
    ...
    function get_content() {
        ...
        $this->content->items[] = '<a title="'.get_string('listofallpeople').'" href="'.
                                  $CFG->wwwroot.'/blocks/idflashcards/idflashcards.php?contextid='.$currentcontext->id.'">'.$icon.get_string('idflashcards','block_idflashcards').'</a>';
